...
#######################################
# Generates the dashboard HTML file by injecting CSS, JS, and variables.
# Globals:
#   SCRIPT_DIR, DASHBOARD_FILE, LAN_IP, DESEC_DOMAIN, PORT_PORTAINER,
#   BASE_DIR, PORT_DASHBOARD_WEB, APP_NAME
# Arguments:
#   None
# Outputs:
#   Writes the generated dashboard to DASHBOARD_FILE.
# Returns:
