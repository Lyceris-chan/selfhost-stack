...
EOF
 ...
 clone_repo "https://github.com/Lyceris-chan/odido-bundle-booster.git" "${SRC_DIR}/odido-bundle-booster" "${ODIDO_BOOSTER_IMAGE_TAG}" & pids+=($!)
 clone_repo "https://github.com/Metastem/Wikiless" "${SRC_DIR}/wikiless" "${WIKILESS_IMAGE_TAG}" & pids+=($!)
 clone_repo "https://github.com/iv-org/invidious.git" "${SRC_DIR}/invidious" "latest" & pids+=($!)
