      ...
      .map(([id, meta]) => {
        ...
        if (id === 'immich' || id === 'immich-server') {
            normalized.chips.push({
                ...
                variant: 'tertiary', 
                icon: 'shield',
                tooltip: 'Internet access is only used to download resources (maps, ML models) to process data locally. No personal data leaves your server.'
            });
        }
  ...
  return card;
        ...
        function renderClientList(clients) {
            ...
            if (!clients || clients.length === 0) {
                list.innerHTML = '<div style="padding: 24px; text-align: center; opacity: 0.6;"><span class="material-symbols-rounded" style="font-size: 48px; line-height: 1; display: block; margin-bottom: 8px;">devices</span><p class="body-medium">No clients configured</p></div>';
                return;
            }
