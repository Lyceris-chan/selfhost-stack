  ...
  return card;
        ...
        async function fetchCertStatus() {
            try {
                ...
                const newClass = isTrusted ? "chip vpn" : (isSelfSigned ? "chip admin" : (data.status === "Rate Limited" ? "chip tertiary" : "chip tertiary"));
                const newContent = isTrusted ? '<span class="material-symbols-rounded" style="font-size:16px;">verified</span> Trusted' :
                                   ...
                                   (data.status === "Rate Limited" ? '<span class="material-symbols-rounded" style="font-size:16px;">timer</span> Rate Limited' : (data.status || "Unknown")));
                ...
                } else if (!data.status || data.status === "Checking...") {
