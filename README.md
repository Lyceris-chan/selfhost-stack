...
| `-a` | **Allow ProtonVPN**: Whitelists ProtonVPN domains (`protonvpn.com`, `proton.me`, `protonmail.com`, `api.protonvpn.ch`) in AdGuard Home to ensure browser extensions work correctly. |
