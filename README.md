...
The stack utilizes a high-performance filtering engine within AdGuard Home, powered by **sleepy list**, which is configured to neutralize advertisements, telemetry, and malicious domains before they reach your devices.
