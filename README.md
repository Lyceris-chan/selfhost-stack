...
| `-a` | **Allow ProtonVPN**: Whitelists ProtonVPN domains in AdGuard Home to ensure browser extensions work correctly. <br> <details><summary>View whitelisted domains</summary><ul><li>@@||getproton.me^</li><li>@@||protonstatus.com^</li><li>@@||protonvpn.ch^</li><li>@@||protonvpn.com^</li><li>@@||protonvpn.net^</li><li>@@||vpn-api.proton.me^</li></ul></details> |
