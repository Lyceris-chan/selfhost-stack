                            ...
                            try:
                                ...
                                if os.path.exists(repo_path) and os.path.isdir(os.path.join(repo_path, ".git")):
                                    ...
                                    if strategy == 'stable':
                                        ...
                                        res_tags = subprocess.run("git tag -l | grep -E '^v?[0-9]+\.[0-9]+\.[0-9]+$' | sort -V | tail -n 1", cwd=repo_path, shell=True, capture_output=True, text=True)
                                        ...
                                        if latest_tag:
                                            ...
                                            log_structured("WARN", f"[Update Engine] No version tag for {name}, using {default_branch}", "MAINTENANCE")
