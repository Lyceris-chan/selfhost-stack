...
PUBLIC_IP=$(curl -s --max-time 5 https://ident.me || curl -s --max-time 5 https://eth0.me || curl -s --max-time 5 https://ifconfig.io/ip || echo "$LAN_IP")
...
NEW_IP=$(curl -s --max-time 5 https://ident.me || curl -s --max-time 5 https://eth0.me || curl -s --max-time 5 https://ifconfig.io/ip || echo "FAILED")
