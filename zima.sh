...
<body>
    <div class="container">
        ...
        <div class="grid">
            <a href="http://$LAN_IP:$PORT_INVIDIOUS" class="card" data-check="true"><h2>Invidious</h2><div class="chip-box"><a href="http://$LAN_IP:$PORT_PORTAINER/#!/1/docker/containers" class="badge vpn" onclick="event.stopPropagation();" title="Manage in Portainer">🔒 Tunneled</a></div><div class="status-pill"><span class="dot"></span><span class="status-text">Checking...</span></div></a>
            ...
            <a href="http://$LAN_IP:$PORT_VERT" class="card" data-check="true"><h2>VERT</h2><div class="chip-box"><a href="http://$LAN_IP:$PORT_PORTAINER/#!/1/docker/containers" class="badge admin" onclick="event.stopPropagation();" title="Manage in Portainer">🏠 LAN Only</a></div><div class="status-pill"><span class="dot"></span><span class="status-text">Checking...</span></div></a>
        </div>
        ...
        <div class="grid-3">
            <a href="http://$LAN_IP:$PORT_ADGUARD_WEB" class="card"><h2>AdGuard Home</h2><div class="chip-box"><a href="http://$LAN_IP:$PORT_PORTAINER/#!/1/docker/containers" class="badge admin" onclick="event.stopPropagation();" title="Manage in Portainer">🏠 LAN Only</a></div></a>
            <a href="http://$LAN_IP:$PORT_PORTAINER" class="card"><h2>Portainer</h2><div class="chip-box"><a href="http://$LAN_IP:$PORT_PORTAINER/#!/1/docker/containers" class="badge admin" onclick="event.stopPropagation();" title="Manage in Portainer">🏠 LAN Only</a></div></a>
            <a href="http://$LAN_IP:$PORT_WG_WEB" class="card"><h2>WireGuard</h2><div class="chip-box"><a href="http://$LAN_IP:$PORT_PORTAINER/#!/1/docker/containers" class="badge admin" onclick="event.stopPropagation();" title="Manage in Portainer">🏠 LAN Only</a></div></a>
        </div>
